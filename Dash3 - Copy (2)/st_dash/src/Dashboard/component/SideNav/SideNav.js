          ...
          >
            <ul className="nav nav-tabs d-block" id="myTab" role="tablist">
              ...
              <li className="nav-item">
                <a className="nav-link d-flex active " href="dashboard">
                  <div className="">
                    <i className="material-icons text-primary">dashboard</i>
                  </div>
                  <span className="nav-link-text ms-1 text-primary">&nbsp;Dashboard</span>
                </a>
              </li>

              <li className="nav-item">
                <a className="nav-link d-flex" href="courses">
                  <div className="">
              ...
              <li className="nav-item">
                <a className="nav-link d-flex" href="event">
                  <div className="">
              ...
              <li className="nav-item">
                <a className="nav-link d-flex" href="Inbox">
                  <div className="">
              ...
              <li className="nav-item">
                <a className="nav-link d-flex" href="resources">
                  <div className="">
              ...
              <li className="nav-item mt-2 ">
                <h4 className="ps-2  text-uppercase text-secondary font-weight-bolder opacity-6">
                  Account Detailss
                </h4>
              </li>
              <li className="nav-item">
                <a className="nav-link d-flex" href="profile">
                  <div className="">
              ...
              <li className="nav-item">
                <a className="nav-link d-flex" href="help">
                  <div className="">
