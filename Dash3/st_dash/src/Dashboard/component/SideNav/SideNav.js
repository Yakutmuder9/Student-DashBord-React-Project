          ...
          >
            <ul className="nav nav-tabs d-block" id="myTab" role="tablist">
              ...
              <li className="nav-item">
                <a className="nav-link d-flex active bg-primary" href="/dashboard">
                  <div className="">
              ...
              <li className="nav-item">
                <a className="nav-link d-flex" href="/course">
                  <div className="">
              ...
              <li className="nav-item mt-3">
                <h4 className="ps-2 ms-2 text-uppercase text-secondary font-weight-bolder opacity-6">
                  Account Detailss
                </h4>
              </li>
              <li className="nav-item">
