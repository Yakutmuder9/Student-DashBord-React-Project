        ...
        <div className=" navbar navbar-main  navbar-expand-lg sticky-top  bg-dark" id="navbar_top">
          <div className="col sticky-top py-1 px-3 d-flex justify-content-between">
            ...
            <nav className="navbar navbar-light d-block .d-sm-none d-lg-none">
              ...
              <div className="collapse navbar-collapse p-3 " id="navbarTogglerDemo02">
                <ul className="navbar-nav mr-auto mt-2 mt-lg-0">
                  ...
                  <li className="nav-item">
                    <a className="nav-link text-secondary" href="resource.html">Resources</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link text-secondary" href="signin.html">Sign in</a>
                  </li>
                </ul>
            ...
            <div aria-label="breadcrumb">
              ...
              <h3 className="font-weight-bolder mb-0 text-secondary"> Dashboard</h3>
            </div>

            <div className="collapse navbar-collapse d-lg-flex justify-content-end mt-sm-0 mt-2 me-md-0 me-sm-4 w-auto"
              id="navbar">
              ...
              <ul className="navbar-nav justify-content-end">
                <li className="nav-item d-flex align-items-center">
                  <a href="" className="nav-link text-body  font-weight-bold px-2 p-1 ml-2 btn btn-outline-primary">
                    ...
                    <span className="d-sm-inline d-none text-white">Log out </span>
                  </a>
                </li>

                <li className="nav-item px-3 d-flex align-items-center">
                  <a href="" className="nav-link text-body p-0">
                    <i className="fa fa-cog text-white cursor-pointer" id="setting"></i>
                  </a>
                </li>
                ...
                <li className="nav-item dropdown pe-2 d-flex align-items-center">
                  <a href="" className="nav-link text-body p-0" id="dropdownMenuButton" data-bs-toggle="dropdown"
                    ...
                    <div className="notification">
                      <span className="badge badge-danger bg-danger  position-absolute">3</span>
                      <i className="fa fa-bell text-white cursor-pointer" id="setting"></i>
                    </div>
                  </a>
                </li>
              </ul>
